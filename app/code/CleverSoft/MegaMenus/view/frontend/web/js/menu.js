 ...
 */
define(['jquery', 'jquery/ui',"js/jquery.noconflict",'domReady'], function($, ui,no,domReady) {
    $.widget('cleversoft.megamenu', {
        options: {
            type: 'horizontal',
            fixedLeftClass: 'clever-fix-left',
            dropdownEffect: 'normal',
            rtlClass: 'rtl-layout',
            verClass: 'clever-vertical-menu',
            horClass: 'clever-horizontal-menu',
            parent: '.parent',
            subMenu: '.clever-mega-menu-sub, .cat-tree .clever-mega-menu-nondrop',
        ...
        _attachEffect: function(type) {
            ...
            $('.level-top', self.element).each(function() {
                var $leveltop = $(this);
                var $drop = $leveltop.children('.clever-mega-menu-sub');
        ...
        _rebuildHtmlStructure: function() {
            ...
            $('.no-dropdown', self.element).each(function() {
                ...
                $noDropdown.children('.clever-mega-menu-sub').removeClass('clever-mega-menu-sub').addClass('groupmenu-nondrop');
            });
        },
        ...
        _alignMenuLeft: function(conf) {
            ...
            $(' > .groupmenu > .level-top > .clever-mega-menu-sub', self.element).parent().on(eventIn, function() {
                var $ddMenu = $(this).children('.clever-mega-menu-sub');
                ...
                $(this).children('.clever-mega-menu-sub').css('left', '');
            });
        },
        _alignMenuRight: function(conf) {
            ...
            $(' > .groupmenu > .level-top > .clever-mega-menu-sub', self.element).parent().on(eventIn, function() {
                ...
                $(this).children('.clever-mega-menu-sub').css('right', '');
            });
        },
        _alignMenuTop: function(conf) {
            var self = this;
            var $win = $(window);
            $(' > .groupmenu > .level-top > .clever-mega-menu-sub', self.element).parent().hover(
                function(){
                    var $li = $(this);
                    var $ddMenu = $(this).children('.clever-mega-menu-sub');
                    $ddMenu.css({top:''});
