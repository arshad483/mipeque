        ...
        return this.each(function(id,el){
            ...
            $.fn.extend({
                ...
                resetFieldId: function(){
                    return this.each(function(){
                        ...
                        $('.menu-field',$item).each(function(index, element) {
                            ...
                            if(type == 'category'){
                                cleverInstantiateChooser(newId);
                            }
                        });
                    });
                },
                ...
                eventOnClickAddLink: function(){
                    return this.each(function(){
                        var $btn = $(this), $item = $btn.parents(conf.items).first();
                        var chkboxs = $item.find('input[data-name="page_selections"]');
                        if (chkboxs.length > 0) {
                            if ($item.find('input[data-name="page_selections"]:checked').length  == 0) return;
                            $item.find('input[data-name="page_selections"]:checked').each(function () {
                                var $text = jQuery(this).data('text');
                                var $val = jQuery(this).val();
                                var $cloneItem = $item.clone();
                                $cloneItem.removeClass(conf.activeClass).addClass(conf.inactiveClass);
                                $cloneItem.find('.menu-item-fields .field__page_selections').remove();
                                $cloneItem.find('.menu-item-bar .link-title').html($text);
                                var $attr = '';
                                $cloneItem.find('.menu-item-fields').before('<div class="menu-item-field row type__text field__label">    <div class="col-xs-4 label"><span>Menu Label</span></div>    <div class="col-xs-8"><input data-type="text" name="label" data-name="label" onkeyup="clevermenu.attachLabel(this);"                                 type="text" class="menu-field field-label" value="'+$text+'"></div></div><div class="menu-item-field row type__text field__url">    <div class="col-xs-4 label"><span>Menu Item URL</span></div>    <div class="col-xs-8"><input name="url" data-type="text" data-name="url" disabled type="text"                                 class="menu-field field-url" value="'+$val+'"></div></div><div class="menu-item-field row type__text field__class">    <div class="col-xs-4 label"><span>Custom CSS Class</span></div>    <div class="col-xs-8"><input data-type="text" data-name="class" type="text" class="menu-field field-class" value="">    </div></div><div class="menu-item-field row type__text field__dropdown_width hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Dropdown Width</span></div>    <div class="col-xs-8"><input data-type="text" data-name="dropdown_width" type="text"                                 class="menu-field field-dropdown-width" value="" placeholder="Example: 500px"></div></div><div class="menu-item-field row type__text field__hide_text hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Text of This Item</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_text" type="checkbox"                                 class="menu-field field-hide-text" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__hide_item_mobile hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Item on Mobile</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_item_mobile" type="checkbox"                                 class="menu-field field-hide-item-mobile" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__hide_sub_menu_mobile hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Sub Menu on Mobile</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_sub_menu_mobile" type="checkbox"                                 class="menu-field field-hide-sub-menu-mobile" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__disable_link_this_item hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Disable Link of This Item</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="disable_link_this_item" type="checkbox"                                 class="menu-field field-disable-link-this-item" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__sub_align hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Sub Menu Align</span></div>    <div class="col-xs-1"><select data-type="select" data-name="sub_align" type="select"                                  class="menu-field field-sub-align">        <option value="0" selected>Drop To Right Side</option>        <option value="1">Drop To Left Side</option>        <option value="2">Drop To Center</option>        <option value="3">Full</option>    </select></div>    <div class="col-xs-7"></div></div>');
                            ...
                            $cloneItem.removeClass(conf.activeClass).addClass(conf.inactiveClass);
                            if  ($cloneItem.attr('data-itemtype') == 'link') var $find = '.menu-item-fields .field__class';
                            if  ($cloneItem.attr('data-itemtype') == 'text') var $find = '.menu-item-fields .field__style';
                            if  ($cloneItem.attr('data-itemtype') == 'category') var $find = '.menu-item-fields .field__display_type';
                            $cloneItem.find($find).after('<div class="menu-item-field row type__text field__dropdown_width hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Dropdown Width</span></div>    <div class="col-xs-8"><input data-type="text" data-name="dropdown_width" type="text"                                 class="menu-field field-dropdown-width" value="" placeholder="Example: 500px"></div></div><div class="menu-item-field row type__text field__hide_text hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Text of This Item</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_text" type="checkbox"                                 class="menu-field field-hide-text" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__hide_item_mobile hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Item on Mobile</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_item_mobile" type="checkbox"                                 class="menu-field field-hide-item-mobile" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__hide_sub_menu_mobile hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Sub Menu on Mobile</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_sub_menu_mobile" type="checkbox"                                 class="menu-field field-hide-sub-menu-mobile" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__disable_link_this_item hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Disable Link of This Item</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="disable_link_this_item" type="checkbox"                                 class="menu-field field-disable-link-this-item" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__sub_align hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Sub Menu Align</span></div>    <div class="col-xs-1"><select data-type="select" data-name="sub_align" type="select"                                  class="menu-field field-sub-align">        <option value="0" selected>Drop To Right Side</option>        <option value="1">Drop To Left Side</option>        <option value="2">Drop To Center</option>        <option value="3">Full</option>    </select></div>    <div class="col-xs-7"></div></div>');
                            $this.append($cloneItem);
                            $('.'+conf.addToMenuClass,$cloneItem).remove();
                            $cloneItem.eventOnClickAllLinks();
                            $cloneItem.resetFieldId();
                        ...
                        if ($('#menu-to-edit .menu-item').length > 0) {
                            $('#text_change_edit').html('Drag each item into the order you prefer. Click the arrow on the right of the item to reveal additional configuration options.');
                        }
            ...
            function initSortable(){
                $this.sortable({
                    ...
                    start: function(event, ui){
                        ...
                        var $item = ui.item;
                        var a = ui.placeholder[0];
                        var b = $item.menuDepthClass();
                    ...
                    sort: function(e,ui){
                        ...
                        if( depth != currentDepth ){
                            ...
                            if (depth > 0 ) {
                                ...
                                if ($(ui.item).find('.hide-on-trigger-parent') > 0) {
                                    $(ui.item).find('.hide-on-trigger-parent').show();
                                } else {
                                    if  ($(ui.item).data('itemtype') == 'page' || el.item_type == 'link') var $find = '.menu-item-fields .field__class';
                                    ...
                                    $(ui.item).find($find).after('<div class="menu-item-field row type__text field__hide_text hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Text of This Item</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_text" type="checkbox"                                 class="menu-field field-hide-text" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__hide_item_mobile hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Item on Mobile</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_item_mobile" type="checkbox"                                 class="menu-field field-hide-item-mobile" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__hide_sub_menu_mobile hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Sub Menu on Mobile</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_sub_menu_mobile" type="checkbox"                                 class="menu-field field-hide-sub-menu-mobile" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__disable_link_this_item hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Disable Link of This Item</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="disable_link_this_item" type="checkbox"                                 class="menu-field field-disable-link-this-item" value="1"></div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__sub_align hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Sub Menu Align</span></div>    <div class="col-xs-1"><select data-type="select" data-name="sub_align" type="select"                                  class="menu-field field-sub-align">        <option value="drop_to_right">Drop To Right Side</option>        <option value="drop_to_left">Drop To Left Side</option>        <option value="drop_to_center">Drop To Center</option>    </select></div>    <div class="col-xs-7"></div></div>');
                                }
                            }
                        }
            ...
            function menuItemTypeTmpl(){
                ...
                $('[data-type="category"]',$menuTypeList).each(function(){
                    var $field = $(this);
                    cleverInstantiateChooser($field.attr('id'));
                });
            ...
            function loadMenu(menuItems){
                ...
                $(menuItems).each(function(id,el){
                    ...
                    if(typeof typeItem !== 'undefined'){
                        ...
                        var $hto = el.content.hide_text == "1" ? 'checked' : '';
                        var $him = el.content.hide_item_mobile == "1"? 'checked' : '';
                        var $hsm = el.content.hide_sub_menu_mobile == "1"? 'checked' : '';
                        var $dlt = el.content.disable_link_this_item  == "1"? 'checked' : '';
                        var $dtr = el.content.sub_align  == "0" ? 'selected' : '';
                        var $dtl = el.content.sub_align  == "1" ? 'selected' : '';
                        var $dtc = el.content.sub_align  == "2" ? 'selected' : '';
                        var $full = el.content.sub_align  == "3" ? 'selected' : '';
                        var $dropw = el.content.dropdown_width  ? el.content.dropdown_width : '';
                        if($dtl == '' && $dtl == '') $dtr = 'selected';
                        if (el.item_type == 'page'){
                            var $text = el.content.label;
                            var $val = el.content.url;
                            var $class = el.content.class;
                            var $new_page_c = $('<div class="menu-item-field row type__text field__label">    <div class="col-xs-4 label"><span>Menu Label</span></div>    <div class="col-xs-8"><input data-type="text" name="label" data-name="label" onkeyup="clevermenu.attachLabel(this);"                                 type="text" class="menu-field field-label" value="'+$text+'"></div></div><div class="menu-item-field row type__text field__url">    <div class="col-xs-4 label"><span>Menu Item URL</span></div>    <div class="col-xs-8"><input name="url" data-type="text" data-name="url" disabled type="text"                                 class="menu-field field-url" value="'+$val+'"></div></div><div class="menu-item-field row type__text field__class">    <div class="col-xs-4 label"><span>Custom CSS Class</span></div>    <div class="col-xs-8"><input data-type="text" data-name="class" type="text" class="menu-field field-class" value="'+$class+'">    </div></div>');
                            var new_page = $('<div class="menu-item-field row type__text field__dropdown_width  hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Dropdown Width</span></div>    <div class="col-xs-8"><input data-type="text" data-name="dropdown_width" type="text"                                 class="menu-field field-dropdown-width" value="'+$dropw+'"                                 placeholder="Example: 500px"></div></div><div class="menu-item-field row type__text field__hide_text hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Text of This Item</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_text" type="checkbox"                                 class="menu-field field-hide-text" '+$hto+' value="1">    </div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__hide_item_mobile hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Item on Mobile</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_item_mobile" type="checkbox"                                 class="menu-field field-hide-item-mobile" '+$him+' value="1">    </div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__hide_sub_menu_mobile hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Hide Sub Menu on Mobile</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="hide_sub_menu_mobile" type="checkbox"                                 class="menu-field field-hide-sub-menu-mobile" '+$hsm+' value="1">    </div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__disable_link_this_item hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Disable Link of This Item</span></div>    <div class="col-xs-1"><input data-type="checkbox" data-name="disable_link_this_item" type="checkbox"                                 class="menu-field field-disable-link-this-item" '+$dlt+' value="1">    </div>    <div class="col-xs-7"></div></div><div class="menu-item-field row type__text field__sub_align  hide-on-trigger-parent">    <div class="col-xs-4 label"><span>Sub Menu Align</span></div>    <div class="col-xs-1"><select data-type="select" data-name="sub_align" type="select"                                  class="menu-field field-sub-align">        <option value="0"        '+$dtr+'>Drop To Right Side</option>        <option value="1"        '+$dtl+'>Drop To Left Side</option>        <option value="2"        '+$dtc+'>Drop To Center</option>        <option value="3"        '+$full+'>Full</option>    </select></div>    <div class="col-xs-7"></div></div>');
                            $item.find('.menu-item-bar .link-title').html($text);
                            $item.find('.menu-item-fields').append($new_page_c);
                        ...
                        $item.find('.menu-item-fields .field__page_selections').remove();
                        ...
                        if  (el.item_type == 'page' || el.item_type == 'link') var $find = '.menu-item-fields .field__class';
                        if  (el.item_type == 'text') var $find = '.menu-item-fields .field__style';
                        if  (el.item_type == 'category') var $find = '.menu-item-fields .field__display_type';
                        if(el.depth ==0) $item.find($find).after(new_page);
                        ...
                        $('.field-icon_type',$item).each(function(){
                            var $iconType = $(this), iconType = $iconType.val(),
                                ...
                                $cleverFontParent = $typeParent.next().next().next();
                            if(iconType == 0){
                                ...
                                $fontParent.show();
                                $cleverFontParent.hide();
                                $imageParent.hide();
                            }else if (iconType == 2) {
                                var $cleverIconFont = $cleverFontParent.find('.field-clever_icon_font');
                                var value = $cleverIconFont.val();
                                if(value != ''){
                                    attachIconToItemHeading($cleverIconFont,value,2);
                                }
                                $cleverFontParent.show();
                                $fontParent.hide();
                                $imageParent.hide();
                            }  else{
                ...
                if ($(menuItems).length > 0) {
                    ...
                    $('#text_change_edit').html('Add menu items from the column on the left.');
                }
                    ...
                    $('.menu-item-field',$fieldsList).each(function(){
                        ...
                        if($field.length > 1){
                            ...
                            $field.each(function(id,el){
                                var $f = $(this);
                                if ($f.data('type') == 'checkbox' && $f.is(':checked')) {
                                    $f.val("1");
                                }else {
                                    if ($f.data('type') == 'checkbox') {
                                        $f.val("0");
                                    }
                                    ////} else {
                                    //    $f.val("");
                            ...
                            if ($field.data('type') == 'checkbox' && $field.is(':checked')) {
                                $field.val("1");
                            } else {
                            ...
                            if ($fieldwrap.hasClass('hide-on-trigger-parent') && $fieldwrap.css('display') == 'none' ) {
                                //do nothing
                            } else itemObject.content[$field.data('name')] = $field.val();
                        }
                    });
            ...
            var $previewForm = $(conf.previewForm);
            function submitForm(){
            ...
            function attachIconToItemHeading(textEl,value, type){
                ...
                if(type == 0){
                    ...
                    $previewIcon.html('<span class="cs-font clever-icon-'+value+'" ></span>');
                    if($textEl.parent().find('.preview-clever_icon').length){
                        var $preview = $textEl.parent().find('.preview-clever_icon');
                        $('span',$preview).removeAttr('class').addClass('cs-font clever-icon-'+value);
                    }
                }  else{
            ...
            var clevermenu = {
                ...
                removeCleverIcon: function(btn){
                    var self = this;
                    var $btn = $(btn), $fieldParent = $btn.parents(self.menuItemField);
                    $('[data-type="icon"]',$fieldParent).val('').trigger('change');
                    $('.preview-clever_icon span',$fieldParent).removeAttr('class');
                },
                ...
                switchIconChooser: function(dropdown){
                    ...
                    var $clever_icon = $parent.next().next().next();
                    var $iconField = $('.field-icon_font',$icon);
                    var $clever_iconField = $('.field-clever_icon_font',$clever_icon);
                    ...
                    if(dropdown.value == 1){
                        ...
                        $image.hide();
                        $clever_icon.show();
                        attachIconToItemHeading($clever_iconField,$clever_iconField.val(),0);
                    } else{
                        $icon.show();
                        $image.hide();
                        $clever_icon.hide();
                    ...
                    $('option[value="'+dropdown.value+'"]',dropdown).attr('selected','selected');
                },
