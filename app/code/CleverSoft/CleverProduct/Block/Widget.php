...
class Widget extends \Magento\Catalog\Block\Product\AbstractProduct implements  \Magento\Widget\Block\BlockInterface {
    ...
    public function renderCollection($type, $value, $template='widget/product.phtml'){
        ...
        $block->setData(array(
            ...
            'column_grid2'   => $this->getConfig('column_grid2'),
            ...
            'display_addtocart'    => $this->getData('display_addtocart')? $this->getData('display_addtocart') : 'hover',
            ...
            'addtolinks_position'    => $this->getData('addtolinks_position')== '1' ? true : false,
