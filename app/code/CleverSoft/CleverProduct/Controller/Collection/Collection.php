...
class Collection extends \Magento\Framework\App\Action\Action{
    ...
    public function execute()
    {
        ...
        $display_addtocart    = $this->getRequest()->getPost('display_addtocart') ? $this->getRequest()->getPost('display_addtocart') : 'hover';
        ...
        $addtolinks_position    = $this->getRequest()->getPost('addtolinks_position',true);
